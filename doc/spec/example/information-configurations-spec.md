...
- **API 規格檔案**: [`InformationConfigurations.yaml`](file:///Users/chi/Documents/ws_riease/ch3-library/vue-backend-template/doc/api/example/InformationConfigurations.yaml)
- **API 版本**: 1.0.0
